  ...
  doEvent(event: any) {
    switch (event.action) {
      ...
      case 'my_account:account:send_request_ownership':
        this.accountService
          .requestOwnership(this.currentUser)
          .subscribe((response: any) => {
            this.toastsService.success(
              'You have just sent request ownership successfully!'
            );
          });
        break;
      case 'my_account:account:accept_request_ownership':
        this.accountService
          ...
          .subscribe((response: any) => {
            this.toastsService.success(
              'You have just accepted request ownership successfully!'
            );
          });
        break;
      case 'my_account:account:reject_request_ownership':
        this.toastsService.success(
          'You have just reject request ownership successfully!'
        );
        break;
