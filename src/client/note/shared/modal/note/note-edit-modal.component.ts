import {
  Component, Input, ViewChild, AfterViewInit, ViewEncapsulation, OnDestroy, SecurityContext,
  OnChanges
} from '@angular/core';
        ...
        if(!i.onclick)
          i.onclick = function(event: any) {
            ...
            if(photoId && photoId !== 'null') {
              ...
              this.router.navigate([{outlets: {modal: ['photos', photoId, {module: 'note', ids: photoIds}]}}], { queryParamsHandling: 'preserve', preserveFragment: true });
            }
            else
