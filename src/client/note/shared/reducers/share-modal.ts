...
export const ADD_SELECTED_CONTACT = 'NOTE_SHARE_MODAL_ADD_SELECTED_CONTACT';
export const SET_SHARED_CONTACTS = 'NOTE_SHARE_MODAL_SET_SHARED_CONTACTS';
export const REMOVE_SHARED_CONTACT = 'NOTE_SHARE_MODAL_REMOVE_SHARED_CONTACT';
